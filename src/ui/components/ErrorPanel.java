...
public class ErrorPanel extends JPanel {
    ...
    public ErrorPanel(String title, String message, RetryListener listener) {
        ...
        JLabel ico = new JLabel("⚠️");
        ico.setFont(new Font("SansSerif", Font.PLAIN, 34));
        ico.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel titleLbl = new JLabel(title == null || title.isBlank() ? "Une erreur est survenue" : title);
        titleLbl.setAlignmentX(Component.CENTER_ALIGNMENT);
        titleLbl.setForeground(UITheme.DANGER);
        titleLbl.setFont(UITheme.FONT_H3);

        JLabel msgLbl = new JLabel("<html><div style='text-align:center;width:260px;'>" +
        ...
        JButton retryBtn = UITheme.primaryButton("Réessayer");
        retryBtn.setAlignmentX(Component.CENTER_ALIGNMENT);
        retryBtn.addActionListener(e -> { if (listener != null) listener.onRetry(); });
